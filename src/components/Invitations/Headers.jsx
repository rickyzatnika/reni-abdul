    ...
    <>
      ...
      <Parallax speed={-125}>
        <div className="w-full min-h-screen overflow-hidden flex flex-col items-center justify-evenly relative">
          <div className="w-full min-h-screen absolute top-0 left-0 -z-40 bg-gradient-to-b from-black/10 to-black/60 mix-blend-overlay" />
          ...
          <motion.div
            ...
            className="w-fit alex text-[#b48f3f] relative border-t-2 border-b-2 py-2 text-center flex flex-col gap-4 items-center"
          >
            <div>
